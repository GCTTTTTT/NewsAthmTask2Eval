...
# 定义预测函数  TODO:缓存操作 若已有文件则直接读取 否则才进行预测
...
T2_file_name = f"./T2WebsiteRanke/T2_{date_UNI}_result_new.csv" ## FIX
...
# 计算body_len_score并添加列
df['T3_S_score'] = 100 * df['T3_S_scale']
...
category_df = pd.read_csv('./T5CateforyScore/category_score_FIX.csv') # FIX
